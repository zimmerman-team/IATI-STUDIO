...
export const getCapital = function (user, publisherId, activityId) {
    const req_options = {
        baseUrl: config.oipa_post_url,
        url: config.comments_url(publisherId, activityId),
        headers: {
...
export const createCapital = function (user, publisherId, activityId, capitalData) {
    const req_options = {
        baseUrl: config.oipa_post_url,
        url: config.comments_url(publisherId, activityId),
        headers: {
...
export const updateCapital = function (user, publisherId, activityId, id, capitalData) {
    const req_options = {
        baseUrl: config.oipa_update_url,
        url: path.join(config.comments_url(publisherId, activityId), `${id}`),
        headers: {
...
export const deleteCapital = function (user, publisherId, activityId, id) {
    const req_options = {
        baseUrl: config.oipa_delete_url,
        url: path.join(config.comments_url(publisherId, activityId), `${id}`),
        headers: {
