...
const ActivitiesList = (props) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <Field name="email" type="email" component={renderField} label="Title"/>
      <Field name="age" type="number" component={renderField} label="Valid"/>
      <div>
...
export default reduxForm({
  form: 'activitiesList',  // a unique identifier for this form
